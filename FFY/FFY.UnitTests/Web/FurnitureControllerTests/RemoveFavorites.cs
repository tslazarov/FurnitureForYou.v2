...
namespace FFY.UnitTests.Web.FurnitureControllerTests
{
    ...
    public class RemoveFavorites
    {
        ...
        public void ShouldRedirectToLogin_WhenUserIsNotAuthenticated()
        {
            ...
            // Act
            furnitureController.WithCallTo(fc => fc.RemoveFavorites(detailedProductViewModel))
        ...
        public void ShouldGetCurrentUserIdPropertyOfAuthenticationProvider()
        {
            ...
            // Act
            furnitureController.RemoveFavorites(detailedProductViewModel);
        ...
        [Test]
        public void ShouldCallPremoveProductFromFavoritesMethodOfUsersService()
        {
            // Arrange
            var id = 4;
            var userId = "42";
            ...
            mockedUsersService.Setup(us => us.GetUserById(It.IsAny<string>()))
                .Returns(user);
            mockedUsersService.Setup(us => us.RemoveProductFromFavorites(It.IsAny<User>(),
            ...
            mockedUsersService.Verify(us =>
                us.RemoveProductFromFavorites(user, product), Times.Once);
        }
