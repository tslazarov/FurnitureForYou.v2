...
namespace FFY.UnitTests.Web.FurnitureControllerTests
{
    ...
    public class AddShoppingCart
    {
        ...
        public void ShouldRedirectToLogin_WhenUserIsNotAuthenticated()
        {
            ...
            // Act
            furnitureController.WithCallTo(fc => fc.AddShoppingCart(detailedProductViewModel))
        ...
        public void ShouldGetCurrentUserIdPropertyOfAuthenticationProvider()
        {
            ...
            // Act
            furnitureController.AddShoppingCart(detailedProductViewModel);
        ...
        public void ShouldCallAddMethodOfShoppingCartsService()
        {
            ...
            mockedShoppingCartsService.Verify(scs => 
                scs.Add(user.ShoppingCart, product, detailedProductViewModel.Quantity), Times.Once);
        }

        [Test]
        public void ShouldCallCartProductsCountMethodOfShoppingCartsService()
        {
            // Arrange
            var id = 4;
            var userId = "42";
            var user = new User() { ShoppingCart = new ShoppingCart() { UserId = userId } };
            var product = new FFY.Models.Product();
            var detailedProductViewModel = new DetailedProductViewModel()
            {
                Product = new Models.Product() { Id = id },
            ...
            // Assert
            mockedShoppingCartsService.Verify(scs =>
                scs.CartProductsCount(userId), Times.Once);
        }
        ...
        public void ShouldCallInsertItemMethodOfCachingProvider()
        {
            ...
            // Assert
            mockedCachingProvider.Verify(cp => cp.InsertItem(It.IsAny<string>(), count), Times.Once);
        }
