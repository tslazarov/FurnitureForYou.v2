...
namespace FFY.UnitTests.Web.FurnitureControllerTests
{
    ...
    public class AddFavorites
    {
        ...
        public void ShouldRedirectToLogin_WhenUserIsNotAuthenticated()
        {
            ...
            // Act
            furnitureController.WithCallTo(fc => fc.AddFavorites(detailedProductViewModel))
        ...
        public void ShouldGetCurrentUserIdPropertyOfAuthenticationProvider()
        {
            ...
            // Act
            furnitureController.AddFavorites(detailedProductViewModel);
        ...
        [Test]
        public void ShouldCallAddProductToFavoritesMethodOfUsersService()
        {
            // Arrange
            var id = 4;
            var userId = "42";
            ...
            mockedUsersService.Setup(us => us.GetUserById(It.IsAny<string>()))
                .Returns(user);
            mockedUsersService.Setup(us => us.AddProductToFavorites(It.IsAny<User>(),
            ...
            mockedUsersService.Verify(us =>
                us.AddProductToFavorites(user, product), Times.Once);
        }
